<?php use App\User; ?>
{{--
    Admin dashboard topbar: mobile sidebar toggle, page title, notification
    bell, and the admin's avatar/name dropdown. Mirrors
    layouts/partials/dashboard-topbar.blade.php (member area). Included by
    layouts/admin/dashboard.blade.php only.
--}}
<header class="ur-dash-topbar">
    <div class="ur-dash-topbar__left">
        ...
        <div class="ur-dash-topbar__title">@yield('dashboard-title', 'Admin Dashboard')</div>
    </div>
