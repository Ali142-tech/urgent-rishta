...
<body class="ur-dash-body pace-done">
    ...
    <style>
        ...
        /* Guard against a Bootstrap modal ever rendering fully opaque instead of the
           standard translucent backdrop (defensive — no known override does this, but
           a modal covering the whole screen in solid black is a bad enough failure
           mode to pin explicitly rather than rely on the library default). */
