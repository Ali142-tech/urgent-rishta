...
<div style="display:none; max-height:0; overflow:hidden; opacity:0; mso-hide:all;">
    Hi {{ $firstName }}, {{ $profiles->count() }} new profiles are waiting for you to review.
</div>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff" class="ur-bg-card" style="max-width:560px; background:#ffffff; border-radius:14px; overflow:hidden; box-shadow:0 4px 18px rgba(18,58,46,0.08);">
        ...
        <tr>
            <td class="ur-px" style="padding:32px 34px 6px; text-align:center;">
                <p class="ur-text-gold" style="margin:0 0 8px; font-size:11.5px; font-weight:700; letter-spacing:1.2px; text-transform:uppercase; color:#C9974D;">Match Preview</p>
                <h1 class="ur-h1 ur-text-green" style="margin:0; font-family: Georgia, 'Times New Roman', serif; font-size:24px; line-height:1.35; color:#123A2E; font-weight:700;">New Profiles Are Waiting to Connect</h1>
            </td>
        </tr>
        ...
        <tr>
            <td class="ur-px" style="padding:12px 34px 26px;">
                <p class="ur-text-body" style="margin:0; font-size:14px; line-height:1.65; color:#3A403C;">Dear {{ $firstName }}, here are a few members you may be interested in. Log in to view their full profile and express interest.</p>
            </td>
        </tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#F6F4EF" class="ur-bg-tile" style="background:#F6F4EF; border-radius:12px;">
                    <tr>
                        ...
                        <td valign="top" style="padding:16px 16px 16px 14px;">
                            ...
                            @endif
                            <a href="https://www.urgentrishta.com/login" class="ur-text-green" style="display:inline-block; font-size:12px; font-weight:700; letter-spacing:.3px; color:#123A2E; text-decoration:underline;">View Profile &rarr;</a>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0">
                    <tr>
                        <td bgcolor="#C9974D" class="ur-bg-accent" style="border-radius:8px; background:#C9974D;">
                            <a href="https://www.urgentrishta.com/login" class="ur-text-green" style="display:inline-block; padding:14px 30px; font-size:13.5px; font-weight:700; letter-spacing:.3px; color:#123A2E; text-decoration:none;">LOG IN TO VIEW ALL</a>
                        </td>
                    </tr>
                </table>
            </td>
